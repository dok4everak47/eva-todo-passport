# FoloToy EVA Todo List (工作牌任务清单)

简体中文 | [English](#english)

一个运行在 **FoloToy AI Passport**(ESP32-C3 工作牌)上的《新世纪福音战士》风格
...
- 240x320 竖屏,高对比度 EVA 风格:黑底 + 荧光绿 `#95EF5E` + 黄 `#FFDC00` + 红 `#FF3232`,全部直角矩形,无圆角无阴影。
- 顶部荧光绿标题块:双语 **任务リスト / TASK LIST**;右侧 **喜碧 / HEBEI** 黄框 + 红色斜线装饰。
...
板级支持包 `components/bsp` 来自 [folotoy/ai-passport](https://github.com/folotoy/ai-passport) 与 [PhoenixZHC/FoloToy-EVA-musicplayer](https://github.com/PhoenixZHC/FoloToy-EVA-musicplayer)(EVA 播放器示例),未修改硬件定义;
...
服务端位于 `server/`,使用 Cloudflare Worker + D1。部署前先准备本地 secrets:
...
非官方粉丝固件,与《EVA》/ NERV / FoloToy 权利方无关联。第三方商标与字体不随
MIT 许可授予,分发前请自行确认资源权利(详见 [NOTICE.md](NOTICE.md))。

---

## English

A fan-made, offline **Neon Genesis Evangelion style Todo List** firmware for the
**FoloToy AI Passport** (ESP32-C3 badge with a 240x320 display and three physical
buttons). It boots straight into the todo screen.

- High-contrast palette: black, EVA green `#95EF5E`, yellow `#FFDC00`, red `#FF3232`; sharp-cornered rectangles only.
